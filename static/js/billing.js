...
function updateNightWidget() {
    // Check if widget exists (it might not be in the HTML yet)
...
// Init Stats and Refresh every 60s
fetchNightStats(); 
setInterval(fetchNightStats, 60000);
...
function showDuplicateSelection(candidates) {
    ...
    candidates.forEach(c => {
        ...
        // --- FIX: Use c.name, c.timestamp, c.charge (Lowercase) ---
        btn.innerHTML = `
            <div>
