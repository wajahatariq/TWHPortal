let allData = { billing: [], insurance: [], stats_bill: {today:0, night:0, pending:0}, stats_ins: {today:0, night:0, pending:0} };
...
// ... Actions (setStatus, searchForEdit, deleteCurrentRecord, update submit handlers) remain same as previous ...
